...
int ConfigureTrigger(INodeMap& nodeMap)
{
    ...
    try
    {
        ...
        {
            cout << "(1) Unable to get or set trigger selector (node retrieval). Aborting..." << endl;
            return -1;
        }
        ...
        {
            cout << "(2) Unable to get or set trigger mode (node retrieval). Aborting..." << endl;
            return -1;
        }
        ...
        if (chosenTrigger == SOFTWARE)
        {
            ...
            CEnumEntryPtr ptrTriggerSourceSoftware = ptrTriggerSource->GetEntryByName("Software"); //"Software"
...
int ResetTrigger(INodeMap& nodeMap)
{
    ...
    try
    {
        ...
        cout << "(2) Trigger mode disabled..." << endl << endl;
    }
    catch (Spinnaker::Exception& e)
    {
        cout << "Error: " << e.what() << endl;
...
int AcquireImages(CameraPtr pCam, INodeMap& nodeMap, INodeMap& nodeMapTLDevice)
{
    ...
    try
    {
        ...
        {
            cout << "(3) Unable to get or set acquisition mode to continuous (node retrieval). Aborting..." << endl << endl;
            return -1;
        }
